    ...
    extends \damix\core\Selector
{
    ...
    public function __construct( string $selector )
    {
        ...
        $this->_dircompletion = \damix\application::getPathApp() . '..' . DIRECTORY_SEPARATOR . 'completion' . DIRECTORY_SEPARATOR . 'boutons' . DIRECTORY_SEPARATOR;
        $this->classnamebase = 'boutons' . $selector;
    }
    ...
    {
        $dir = strtolower( $this->_part['module'] . DIRECTORY_SEPARATOR . 'boutons' . DIRECTORY_SEPARATOR . $this->getPart( 'resource' ) . '_' . $this->getPart( 'function' ) );
